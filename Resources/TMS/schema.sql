...
ALTER TABLE `VGSRPCONDITIONSS_RO` CHANGE `SURVEYTYPEID` `SURVEYTYPEID` VARCHAR(255) NULL DEFAULT NULL;
...
CALL sp_DropIndex ('VGSRPCONDITIONSS_RO', 'SURVEYTYPEID');
ALTER TABLE `VGSRPCONDITIONSS_RO` ADD INDEX `SURVEYTYPEID` ( `SURVEYTYPEID` );
